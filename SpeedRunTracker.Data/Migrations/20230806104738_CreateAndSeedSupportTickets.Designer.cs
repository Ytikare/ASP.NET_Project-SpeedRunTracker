...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpeedRunTracker.Data.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f808b07a-fb80-414e-b24a-ce392cb91729"),
                            Content = "Most of my speedruns have not been verified. Since all of them are valid, would you verify them, please?",
                            IsActive = true,
                            IsDeclined = false,
                            IssueDate = new DateTime(2023, 7, 14, 10, 50, 40, 0, DateTimeKind.Local),
                            IssuerId = new Guid("d5001448-ac7a-4666-824d-f6a48228b3b0"),
                            Title = "Requesting speedrun verification"
                        },
                        new
                        {
                            Id = new Guid("921296be-33ca-4853-887c-7c5cea0e0f2b"),
                            Content = "I request the game Only Up! to be added. since it has a large speedrunning commynity around it.",
                            IsActive = true,
                            IsDeclined = false,
                            IssueDate = new DateTime(2023, 7, 3, 10, 50, 40, 0, DateTimeKind.Local),
                            IssuerId = new Guid("d5001448-ac7a-4666-824d-f6a48228b3b0"),
            ...
            modelBuilder.Entity("SpeedRunTracker.Data.Entities.SupportTicket", b =>
                {
                    b.HasOne("SpeedRunTracker.Data.Entities.AppUser", "Issuer")
                        .WithMany()
